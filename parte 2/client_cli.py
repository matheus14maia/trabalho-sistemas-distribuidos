...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cliente CLI para o serviço RPC do KV Store (parte 2).")
    parser.add_argument(
        "--target", default="localhost:50051", help="host:porta do serviço gRPC (ex.: node1:50051)"
    )
